...
public class Jour3A {
    ...
    public static void main(String[] args) {
        generatePath(wireA, false);
        generatePath(wireB, true);
        ...
        System.out.println("Closest distance: " + distances.get(0));
    }
